...
from social_app.models import Like, User, UserPost
from social_app.serializers import UserPostSerializer, UserSerializer
...
class AuthenticationTestCase(APITestCase):
    ...
    def test_user_creation_should_fail_when_invalid_email_passed(
        ...
        data = {"email": "test@.com", "name": "my test", "password": "not_a_password"}
    ...
    def test_user_creation_should_be_successful_when_valid_email_passed(
        self, mock_tasks, mock_utils, mock_get_client_ip
    ):
        """
    ...
    def test_login_return_token_given_valid_credentials(self):
        ...
        credentials = {"email": "test.user@email.com", "password": "password"}
    ...
    def test_login_does_not_return_token_given_invalid_credentials(self):
        ...
        credentials = {"email": "test.user@email.com", "password": "password5"}
...
class UserPostTestCase(APITestCase):
    def setUp(self):
        ...
        self.initial_request = {"text": "testing post creation"}
        ...
        self.access_token = self.client.post(
            self.login_url, {"email": "test.user@email.com", "password": "password"}
        ).json()["access"]
    ...
    def test_update_post_success_when_valid_request_body_passed(self):
        ...
        update_request = {"postId": 1, "text": "updated post"}
    ...
    def test_update_post_fail_when_invalid_request_body_passed(self):
        ...
        update_request = {"postingId": 1, "text": "updated post"}
